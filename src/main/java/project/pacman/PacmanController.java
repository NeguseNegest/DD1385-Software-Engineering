...
public class PacmanController implements GameLoopListener {
    ...
    public void onGameTick() {
        if (!model.checkLossCondition()) {
            //sound.playSound("Slower-Tempo-2020-03-22_-_8_Bit_Surf_-_FesliyanStudios.com_-_David_Renda.mp3");
            ...
            if (model.checkWinCondition()) {
                onGameWin();
                //sound.playSound("pacman_intermission.wav");
    ...
    public void onGameWin() {
        ...
        view.displayMessage("you_won.png");
    ...
    public void onGameLoss() {
        timer.stop();
        view.displayMessage("game_over.png");
        //sound.stopBackgroundMusic();
    }
